...
namespace StudentPartners.Controls
{
    public class CardView : ContentView
    {
        ...
        public CardView()
        {
            ...
            textLabel = new Label
            {
                FontSize = Device.OnPlatform<double>(20, 20, 20),
            ...
            {
                FontSize = Device.OnPlatform<double>(16, 16, 16),
                TextColor = Device.OnPlatform<Color>(Color.FromHex("8F8E94"), Color.FromHex("8F8E94"), Color.FromHex("8F8E94")),
                HorizontalOptions = LayoutOptions.Center,
                HorizontalTextAlignment = TextAlignment.Center,
                Margin = Device.OnPlatform<Thickness>(new Thickness(12, 0, 10, 0), new Thickness(20, 0, 20, 0), new Thickness(20, 0, 20, 0)),
                LineBreakMode = LineBreakMode.WordWrap,
                VerticalOptions = LayoutOptions.End,
